      ...
      >
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="p-4 sm:p-6 flex-grow">
            ...
            <p className="text-zinc-400 mb-4 text-sm sm:text-base">{description}</p>

            <div className="flex flex-wrap gap-2">
              {tags.map((tag, index) => (
                <Badge key={index} variant="secondary" className="bg-zinc-700/50 hover:bg-zinc-700 text-zinc-300 text-xs">
                  {tag}
                </Badge>
              ))}
            </div>
