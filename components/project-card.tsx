              ...
              {hasLiveDemo ? (
                <motion.div className="flex-1" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Link href={demoUrl} target="_blank" rel="noopener noreferrer" className="block">
                    <Button
                      size="sm"
                      className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-blue-500 hover:to-indigo-500 text-white border-0 relative overflow-hidden shadow-lg"
                    >
                      <motion.div
                ...
                <motion.div className="flex-1" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    size="sm"
                    disabled
                    className="w-full bg-slate-700/50 text-slate-500 border border-slate-600 cursor-not-allowed"
                  >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href={repoUrl} target="_blank" rel="noopener noreferrer">
                  <Button
                    size="sm"
                    variant="outline"
                    className="border-slate-600 text-slate-400 hover:text-white hover:border-cyan-400 bg-transparent backdrop-blur-sm relative overflow-hidden"
                  >
                    <motion.div
